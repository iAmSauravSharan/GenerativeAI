...
import com.sauravsharan.generativeai.openai.request.images.ImageEditRequest
...
class OpenAiApi(private val api: OpenAi) {
    ...
    /**
     * do send promopt in request instead of messages
     */
    ...
    /**
     * do send messages in request instead of prompt
     */
    fun chatCompletions(request: CompletionRequest): CompletionResponse {
        return api.chatCompletion(request).blockingGet()
    }
