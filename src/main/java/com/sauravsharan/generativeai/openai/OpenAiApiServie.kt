...
import com.sauravsharan.generativeai.openai.interceptor.AuthenticationInterceptor
...
open class OpenAiApiService(private val token: String, private val timeout: Int = 5) {

    private var baseUrl = "https://api.openai.com/v1/"
    private val client: OkHttpClient
    private val mapper = ObjectMapper().registerKotlinModule()
    private lateinit var api: OpenAi
    ...
    fun baseUrl(url: String): OpenAiApiService {
        this.baseUrl = url;
        return this;
    }
